...
out.print(bookid+"  "+bookname+ "  "+bookwriter);

PreparedStatement stmt1=conn.prepareStatement("update book set bookname=?, bookwriter=?, username=? where bookid=?");


stmt1.setString(4, bookid);
stmt1.setString(1, bookname);
stmt1.setString(2, bookwriter);
